...
import os
import chains.local_doc_qa as doc_qa
...
doc_qa.local_doc_qa = local_doc_qa
...
def get_answer(query, vs_path, history, mode, score_threshold=VECTOR_SEARCH_SCORE_THRESHOLD,
    ...
    if mode == "Bing搜索问答":
        ...
        for resp, history in local_doc_qa.get_knowledge_based_answer(
            ...
            print(">>>>>")
            print(query, vs_path, history, streaming)
            print("<<<<<")
            source = "\n\n"
            source += "".join(
...
webui_title = """
# 🎉langchain-character-lab WebUI🎉
"""
default_vs = get_vs_list()[0] if len(get_vs_list()) > 1 else "为空"
init_message = f"""欢迎使用 langchain-character-lab Web UI！
        ...
        with gr.Row():
            ...
            with gr.Column(scale=5):
                ...
                with vs_setting:
                    ...
                    vs_delete = gr.Button(value="删除本知识库", visible=False)
